...
/**
 * Optional community detection configuration. Controls whether community
 * summaries are generated by an LLM or synthetically from entity metadata.
 */
#[derive(Debug, Default, Deserialize)]
#[serde(default)]
pub struct CommunitySection {
    pub llm_summaries: Option<bool>,
    pub base_url: Option<String>,
    pub model: Option<String>,
    pub api_key: Option<String>,
}
